...
<html>
    ...
    <body>
        ...
        <div id="content" class="container">
            ...
            <br>
            <ol>
                <li>Halaman buat tes dapat dibuka oleh Admin dengan mengklik 'My Profil' pada sidebar. 
                <img id="buattes" style="width: 80%" src="assets/images/profiladmin.png">
                </li>
                <br>
                <li>Berikut adalah tampilan dari profil Admin
                <img id="buattes" style="width: 80%" src="assets/images/profiladmin1.png">
                </li>
                <br>
